...
public class astro {
    ...
    private byte is_moon_up;
    private byte is_sun_up;
    ...
    public byte getIs_moon_up() {
        return is_moon_up;
    }

    public void setIs_moon_up(byte is_moon_up) {
        this.is_moon_up = is_moon_up;
    }

    public byte getIs_sun_up() {
        return is_sun_up;
    }

    public void setIs_sun_up(byte is_sun_up) {
